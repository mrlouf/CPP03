...
/*   Updated: 2025/02/16 15:32:39 by nponchon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string &target) {
	switch (_energyPoints == 0 || _hitPoints == 0) {
	case true:
		std::cout << "ClapTrap " << _name << " does not have enough energy or hitpoints to attack!";
		std::cout << std::endl;
		break;
	case false:
